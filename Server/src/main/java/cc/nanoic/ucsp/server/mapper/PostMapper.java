...
public interface PostMapper {
    ...
    void numUpdate(@Param("num") Integer num, @Param("type") String type);
    ...
    Integer numSelectMax(@Param("p") String p);
...
//    void deletePost(@Param("p") String p, @Param("id") Integer id);
    ...
    void insertPost_study(@Param("p") String p, @Param("title") String title,//文章标题
                          @Param("author_id") Integer author_id,//作者ID
                          @Param("intro") String intro,//摘要
                          @Param("content") String content,//文章正文
                          @Param("post_cover") String post_cover,//文章封面
    ...
    void updatePost_study(@Param("p") String p, @Param("title") String title,//文章标题
                          @Param("intro") String intro,//摘要
                          @Param("content") String content,//文章正文
                          @Param("post_cover") String post_cover,//文章封面
                          @Param("id") Integer id,//文章id
     ...
     */
    @Insert("insert into `${p}` value (null,#{title},#{author_id},#{intro},#{content},1,#{post_cover},null,#{create_time},#{update_time},0,0,0,#{tag})")
    void insertPost_share(@Param("p") String p, @Param("title") String title,//文章标题
                          @Param("author_id") Integer author_id,//作者ID
                          @Param("intro") String intro,//摘要
                          @Param("content") String content,//文章正文
                          @Param("post_cover") String post_cover,//文章封面
