...
import { studypostStore } from '@/stores/studycontent'
import { studycontent } from '@/api/studypost'

const studypost = studypostStore()
...
must.value.post_id = JSON.parse(localStorage.getItem('postid'))

const message = ref([])

const readstatic = async () => {
  const ress = await studycontent(must.value)
  console.log(ress.data.data)
  message.value.push(ress.data.data)
...
<template>
  <div class="messageContent">
    <div class="body" v-for="(item, index) in message" :key="index">
      <div class="top">
    ...
    <div class="foot">
      <div class="data" v-for="item in statics" :key="item">
        <div class="contain">
          ...
          <div class="text">{{ item.names.in }}</div>
        </div>
      </div>
    </div>
  </div>
